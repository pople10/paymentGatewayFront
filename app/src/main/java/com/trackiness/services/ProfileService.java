...
public class ProfileService {
    ...
    public void getProfileData(VolleyCallBack callBack)
    {
        String url = context.getString(R.string.server)+"/account/profile";
        callBack.beforeSend();
        StringRequest stringRequest = new StringRequest(Request.Method.GET,url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        profile = new Gson().fromJson(response, listType);
                        callBack.onSuccess();
                        callBack.onFinish();
                    }
